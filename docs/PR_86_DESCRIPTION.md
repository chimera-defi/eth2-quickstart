...
- **Idempotency**: JWT by execution client; execution before consensus; NTP/tzdata defaults
...
| `run_2.sh` | Logging, execution→consensus order, JWT fallback, security validation debug |
