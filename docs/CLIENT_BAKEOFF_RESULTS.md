...
| --- | --- | --- | --- |
| nethermind | ~251 GiB (268,110,243,338 B) | **~1.06 TiB** (state ~226 GiB + ~842 GiB post-merge bodies/receipts) | Grew after sync as FastBlocks backfilled post-merge history. |
| ethrex | ~286 GiB (306,564,007,339 B, 2026-07-06 run, v19.0.0); ~300 GiB (this run, 2026-07-28, v22.0.0, at 4h09m56s) | **~470 GiB plateau** (471.9 GiB; oscillates 470.0–472.3 GiB) | +43 GiB/hr during post-sync settling, then collapsed ~200× to +0.22 GiB/hr, flat 8.8+ hours. No-history node — not pruned-comparable to the rows below. The two runs used different ethrex versions (v19.0.0 → v22.0.0) as well as different days/host load. |
