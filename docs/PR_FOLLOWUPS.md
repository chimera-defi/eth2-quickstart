...
- `#136`, `#139`, `#140`: consolidated and finished in `#143`.
...
- `#131`, `#132`, `#133`, `#134`: audit/docs/frontend cleanup work was absorbed by later merged cleanup passes (`#135`, `#145`, `#150`).

## Still Optional to Revisit

- `#141` opt-in Prysm checkpoint smoke verification:
  - local/live smoke coverage exists on `master` through follow-up work (`#142` and later cleanup),
  - what remains optional is enabling a stable CI path for that smoke in a way that does not add flake or excessive runtime.
