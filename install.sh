...
echo ""
echo -e "${YELLOW}Alternatively, use the pre-existing run_1.sh and run_2.sh:${NC}"
echo -e "  Phase 1: ${BLUE}cd $INSTALL_DIR && ./run_1.sh${NC} (then reboot)"
echo -e "  Phase 2: ${BLUE}cd ~/eth2-quickstart && ./run_2.sh${NC}"
echo ""
