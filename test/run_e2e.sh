...
if [[ "$PHASE" == "1" ]]; then
    ...
    [[ -n "${E2E_PRYSM_CHECKPOINT_SMOKE:-}" ]] && DOCKER_E2E+=(-e "E2E_PRYSM_CHECKPOINT_SMOKE=$E2E_PRYSM_CHECKPOINT_SMOKE")
    [[ -n "${PRYSM_CHECKPOINT_REQUIRE_DOWNLOAD_LOG:-}" ]] && DOCKER_E2E+=(-e "PRYSM_CHECKPOINT_REQUIRE_DOWNLOAD_LOG=$PRYSM_CHECKPOINT_REQUIRE_DOWNLOAD_LOG")
    [[ -n "${PRYSM_CHECKPOINT_REQUIRE_FALLBACK_LOG:-}" ]] && DOCKER_E2E+=(-e "PRYSM_CHECKPOINT_REQUIRE_FALLBACK_LOG=$PRYSM_CHECKPOINT_REQUIRE_FALLBACK_LOG")
