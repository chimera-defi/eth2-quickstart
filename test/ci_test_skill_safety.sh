...
ALL_SKILL_FILES=("$SKILL_FILE" "$SAFETY_REF" "$COMMANDS_REF" "$SKILL_DIR/references/workflow.md" "$SKILL_DIR/references/operator.md" "$SKILL_DIR/references/outputs.md" "$SKILL_DIR/references/examples.md")
