...
- Install path for external agents: `git clone https://github.com/chimera-defi/eth2-quickstart.git && cd eth2-quickstart` (registry installs like `clawhub install eth2-quickstart` are not yet published and do not work today)
...
- This skill ships inside the eth2-quickstart repo and only makes sense inside a repo checkout. It is not yet published to ClawHub or any other skill registry.
