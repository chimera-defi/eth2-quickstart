...
echo "2. Configure sudo access for $LOGIN_UNAME (run in another terminal):"
echo "sudo visudo"
...
echo "3. Set a password for your new user:"
echo "sudo passwd $LOGIN_UNAME"

# Security validation will be run at the end of run_2.sh

echo "Done. Run 'sudo reboot' for all changes to take effect"
echo "After reboot, login as $LOGIN_UNAME and run './run_2.sh'"
