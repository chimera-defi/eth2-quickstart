...
echo "2. Please run the following cmds now in another shell and add the line to the file that pops up"
echo "   to enable $LOGIN_UNAME no-prompt sudo to help run the second stage"
