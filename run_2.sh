...
# Install default Ethereum clients
...
# Display client selection information
cat << EOF

=== Client Selection Information ===

Default clients have been installed. If you want to use different clients, you can:

1. View available clients: ./install/utils/select_clients.sh
2. Install alternative clients manually:
   - Execution: ./install/execution/install_nethermind.sh
   - Consensus: ./install/consensus/install_teku.sh
   - See README.md for complete list

3. Stop current services before switching:
